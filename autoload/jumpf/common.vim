" Parts of this file taken from https://github.com/vim-scripts/jumpf
...
"   3.00.001	08-Feb-2012	file creation from autoload/jumpf.vim.
let s:save_cpo = &cpo
set cpo&vim

function! jumpf#common#GetJumps( command )
    redir => l:jumpsOutput
...
function! jumpf#common#SliceJumpsInDirection( jumps, isNewer )
"******************************************************************************
"* PURPOSE:
...
function! jumpf#common#ParseJumpLine( jumpLine )
